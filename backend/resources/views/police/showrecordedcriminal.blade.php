                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h4 class="card-title text-primary mb-0">
                            <i class="fas fa-user-shield mr-2"></i> Criminal Records
                        </h4>
                            ...
                            <tbody>
                                @foreach ($types as $key => $items)
                                    <tr class="hover-shadow">
                                        ...
                                        <td>
                                            <span class="badge {{ $items->gender == 'Male' ? 'badge-primary' : 'badge-pink' }}">
                                                <i class="fas {{ $items->gender == 'Male' ? 'fa-mars' : 'fa-venus' }} mr-1"></i>
                                                {{ $items->gender }}
                                            </span>
                                        </td>
                                        <td class="text-center">
                                            <div class="profile-thumbnail-container">
                                                <img class="wd-80 rounded-circle clickable-photo shadow-sm" 
                                                    src="{{ !empty($items->photo) ? url('upload/admin_image/' . $items->photo) : url('upload/no_image.jpg') }}" 
                                                    alt="Criminal Photo" 
                                                    data-fullsrc="{{ !empty($items->photo) ? url('upload/admin_image/' . $items->photo) : url('upload/no_image.jpg') }}"
                                                    data-name="{{ $items->fname }} {{ $items->lname }}">
                                        ...
                                        <td>
                                            <span class="flag-icon flag-icon-{{ strtolower($items->nationality) }} mr-2"></span>
                                            {{ $items->nationality }}
                                        </td>  
